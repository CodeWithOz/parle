...
export const AdThumbnail: React.FC<AdThumbnailProps> = ({ imageDataUrl, onOpenLightbox }) => {
  return (
    <button
      ...
      className="relative group w-9 h-9 flex-shrink-0 rounded-lg overflow-hidden border border-parle-navy-200 hover:border-parle-blue-400 transition-colors focus:outline-none focus:ring-2 focus:ring-parle-blue-500"
